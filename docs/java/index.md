...
|---|--------|-----------|------------|
| 01 | *(in arrivo)* | Hello World e struttura base | :material-circle-outline: Base |
| 02 | *(in arrivo)* | Variabili, tipi e operatori | :material-circle-outline: Base |
| 03 | *(in arrivo)* | Cicli e array | :material-circle-slice-4: Intermedio |
| 04 | *(in arrivo)* | Prima classe: attributi e metodi | :material-circle-slice-4: Intermedio |
| 05 | *(in arrivo)* | Ereditarietà | :material-circle-slice-4: Intermedio |
| 06 | *(in arrivo)* | Interfacce | :material-circle: Avanzato |
| 07 | *(in arrivo)* | Gestione delle eccezioni | :material-circle: Avanzato |
